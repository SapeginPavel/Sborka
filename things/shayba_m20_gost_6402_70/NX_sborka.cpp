#include <uf.h>
#include "9_Shayba_20L_65G_013_GOST_6402-70.h"
...
tag_t drawLineTag(double start_point[3], double end_point[3]) {
...
void extrudeSketch(tag_t sketch, int length) {
    uf_list_p_t Ext3;
...
void ufusr(char* param, int* retcode, int paramLen) {
    ...
    draw_9_Shayba_20L_65G_013_GOST_6402(0, 0, 0);
